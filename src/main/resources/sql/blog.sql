...
*/
-- 参考 https://blog.csdn.net/chachapaofan/article/details/86571657
...
CREATE TABLE `t_articles`  (
  ...
  `article_description` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '博文简介',
...
CREATE TABLE `t_users`  (
  ...
  `user_status` int NOT NULL COMMENT '用户状态-1, 冻结, 0, 正常',
